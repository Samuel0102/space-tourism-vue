<template>
  <section id="technology" class="pt-24 text-white text-center">
    <PageTitle :title="'Space Launch 101'" :numeration="'03'" />
...
export default {
  components: { PageTitle, TechnologySlider },
  data() {
    return {
      technologies: [
        {
          name: "Launch Vehicle",
          img: require("@/assets/img/technology/image-launch-vehicle-landscape.jpg"),
          description: `
        ...
        {
          name: "Spaceport",
          img: require("@/assets/img/technology/image-spaceport-landscape.jpg"),
          description: `
        ...
        {
          name: "Space Capsule",
          img: require("@/assets/img/technology/image-space-capsule-landscape.jpg"),
          description: `
